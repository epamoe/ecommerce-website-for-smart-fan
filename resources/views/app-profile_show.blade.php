...
<head>
	...
	<link href="{{url('backend/vendor/lightgallery/css/lightgallery.min.css')}}" rel="stylesheet">
...
<body>
                            ...
                            <div class="profile-head">
                                ...
                                <div class="profile-info">
									...
									<div class="profile-details">
										@foreach($profile as $elmt)
											<div class="profile-name px-3 pt-2">
												<h4 class="text-primary mb-0">{{$elmt->name}}</h4>
												<p>{{$elmt->country}} / {{$elmt->ville}}</p>
											</div>
											<div class="profile-email px-2 pt-2">
												<h4 class="text-muted mb-0">{{$elmt->email}}</h4>
												<p>Email</p>
											</div>
									...
									<div class="card-body">
										<div class="profile-statistics">
											<div class="text-center">
												...
												<div class="row">
													<div class="col">
														<h3 class="m-b-0">{{$elmt->nbr_share}}</h3><span>Nombre de Parts</span>
													</div>
													<div class="col">
														<h3 class="m-b-0">{{$elmt->montant_investit}} Fcfa</h3><span>Montant investit</span>
													</div>
												</div>
												@endforeach
											</div>
                                                    ...
                                                    <div class="post-input">
														...
														<div class="modal fade" id="postModal">
															<div class="modal-dialog modal-dialog-centered" role="document">
																<div class="modal-content">
																	<div class="modal-header">
																		<h5 class="modal-title">Please provide your email</h5>
																		<button type="button" class="close" data-dismiss="modal"><span>&times;</span>
																		</button>
																	</div> <!--smartfan getter !-->
																	<div class="modal-body">
																		<form method="POST" action="/profile">
																			@csrf
																			<input type="email" required name="email" id="textarea2" cols="30" rows="5" class="form-control bg-transparent" placeholder="Please type the user email"></textarea>
																			<button type="submit" class="btn btn-primary btn-rounded" > Find </button>
                                            ...
                                            <div id="about-me" class="tab-pane fade">
                                                ...
                                                <div class="profile-personal-info">
                                                    ...
                                                    <div class="row mb-2">
                                                        ...
                                                        <div class="col-sm-9 col-7"><span>{{$elmt->name}}</span>
                                                        </div>
                                                    </div>
                                                    <div class="row mb-2">
                                                        <div class="col-sm-3 col-5">
                                                        ...
                                                        <div class="col-sm-9 col-7"><span>{{$elmt->last_name}}</span>
                                                        </div>
                                                    </div>
                                                    <div class="row mb-2">
                                                        <div class="col-sm-3 col-5">
                                                        ...
                                                        <div class="col-sm-9 col-7"><span>{{$elmt->email}}</span>
                                                        </div>
                                                    </div>
                                                    <div class="row mb-2">
                                                        <div class="col-sm-3 col-5">
                                                            <h5 class="f-w-500">Pays <span class="pull-right">:</span>
                                                            </h5>
                                                        </div>
                                                        <div class="col-sm-9 col-7"><span>{{$elmt->country}}</span>
                                                        </div>
                                                    </div>
                                                    <div class="row mb-2">
                                                        <div class="col-sm-3 col-5">
                                                        ...
                                                        <div class="col-sm-9 col-7"><span>{{$elmt->phone}}</span>
                                                        </div>
                                                    </div>
                                                    <div class="row mb-2">
                                                        <div class="col-sm-3 col-5">
                                                        ...
                                                        <div class="col-sm-9 col-7"><span>{{$elmt->ville}}</span>
                                                        </div>
                                                    </div>
													<div class="row mb-2">
                                                        <div class="col-sm-3 col-5">
                                                            <h5 class="f-w-500">Avatar<span class="pull-right">:</span></h5>
                                                        </div>
                                                        <div class="col-sm-9 col-7"><span>avatar</span>
                                                        </div>
                                                    </div>
													<div class="row mb-2">
                                                        <div class="col-sm-3 col-5">
                                                        ...
                                                        <div class="col-sm-9 col-7"><span>{{$elmt->date_naiss}}</span>
                                                        </div>
                                                    </div>
													<div class="row mb-2">
                                                        <div class="col-sm-3 col-5">
                                                        ...
                                                        <div class="col-sm-9 col-7"><span>{{$elmt->address}}</span>
                                                        </div>
                                                    </div>
													<div class="row mb-2">
                                                        <div class="col-sm-3 col-5">
                                                        ...
                                                        <div class="col-sm-9 col-7"><span>{{$elmt->description}}</span>
                                                        </div>
                                                    </div>
													@endforeach
                                                </div>
                                            ...
                                            <div id="profile-settings" class="tab-pane fade">
                                                <div class="pt-3">
                                                    <div class="settings-form">
                                                        ...
                                                        <form method="post" action="profile-setting">
															@csrf
															<input type="text" name="reference" hidden value="{{$elmt->pk}}" class="form-control">
                                                            <div class="form-row ">
																<div class="form-group col-md-6">
																	<label class="f-w-500">Name</label>
																	<input type="text" name="name" placeholder="{{$elmt->name}}" class="form-control">
																</div>
																<div class="form-group col-md-6">
																	<label>Last name</label>
																	<input type="text" name="last_name" placeholder="{{$elmt->last_name}}" class="form-control">
																</div>
															</div>
															<div class="form-row">
                                                                <div class="form-group col-md-6">
                                                                    <label>Email</label>
                                                                    <input type="email" disabled  name="email" placeholder="{{$elmt->email}}" class="form-control">
                                                                </div>
                                                                <div class="form-group col-md-6">
                                                                    <label>Password</label>
                                                                    <input type="password" disabled placeholder="Your old password is hiden" class="form-control">
                                                                </div>
                                                            </div>
															...
															<div class="form-row">
																<div class="form-group col-md-6">
																	<label>Address</label>
																	<input type="text" name="address" placeholder="{{$elmt->address}}" class="form-control">
																</div>
																<div class="form-group col-md-6">
																	<label>Ville</label>
																	<input type="text" name="ville" placeholder="{{$elmt->ville}}" class="form-control">
																</div>
															</div>
                                                            <div class="form-row">
                                                                <div class="form-group col-md-4">
                                                                    <label>country</label>
                                                                    <select name="country" class="form-control default-select" id="inputState">
                                                                        <option selected="{{$elmt->country}}">{{$elmt->country}}.</option>
                                                                ...
                                                                <div class="form-group col-md-8">
                                                                    ...
                                                                    <input type="text" name="description" class="form-control" placeholder="{{$elmt->description}}">
                                                                </div>
                                                            ...
                                                            <div class="form-group">
                                                                <div class="custom-control custom-checkbox">
																	...
																	<label class="custom-control-label" required for="gridCheck"> Check me out</label>
																</div>
                                                            </div>
    ...
    ***********************************-->
	...
	<script src="{{url('backend/vendor/lightgallery/js/lightgallery-all.min.js')}}"></script>
