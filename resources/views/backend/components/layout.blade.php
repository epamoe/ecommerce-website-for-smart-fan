...
<head>
	...
	<meta name="description" content="SmartFan Technology" />
	<meta property="og:title" content="SmartFan Technology" />
	<meta property="og:description" content="SmartFan Technology" />
	<meta property="og:image" content="{{asset('frontend/images/logo.jpg')}}" />
	<meta name="format-detection" content="telephone=no">
    <title>SmartFan Technology</title>
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="{{asset('frontend/images/logo.jpg')}}">
...
<body>
    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="{{route('back.home')}}" class="brand-logo ">
              <img style="height:100px" src="{{asset('frontend/images/logo.jpg')}}" />
            </a>
        ...
        ***********************************-->
		...
		<!--**********************************
            Header start
        ***********************************-->
        @include('backend.components.horizontalside')
        <!--**********************************
        ...
        ***********************************-->
        ...
        <!--**********************************
            Sidebar start
        ***********************************-->
        @include('backend.components.verticalside')
        <!--**********************************
            Sidebar end
        ***********************************-->
        ...
        ***********************************-->
        <div class="footer">
            <div class="copyright">
                <p>Copyright © Designed &amp; Developed by <a href="https://tagusdrone.com/" target="_blank">Tagusdrone</a> 2022</p>
            </div>
        </div>
        <!--**********************************
            Footer end
    ...
    ***********************************-->
    ...
    <script src="{{asset('backend/vendor/flot-spline/jquery.flot.spline.min.js')}}"></script>
	...
	<!-- Chart piety plugin files -->
	<script src="{{asset('backend/js/plugins-init/piety-init.js')}}"></script>
