...
<div class="container-fluid">
    <div class="form-head mb-sm-5 mb-3 d-flex flex-wrap align-items-center">
        <h2 class="font-w600 title mb-2 mr-auto ">{{Auth::user()->name}}</h2>
    ...
    <div class="col-xl-9 col-xx-8">
																...
																<div class="row"> 
																	<div class="col-lg-6">
																		<div class="form-group">
																			<label class="text-black font-w600">Nom <span class="required">*</span></label>
																			<input type="text" value="{{Auth::user()->name}}" class="form-control" value="Author" name="Author" placeholder="Author">
																		</div>
																	</div>
																	<div class="col-lg-6">
																		<div class="form-group">
																			<label class="text-black font-w600">Prenom <span class="required">*</span></label>
																			<input type="text"  value="{{Auth::user()->last_name}}" class="form-control" value="Email" placeholder="Email" name="Email">
																		</div>
																	</div>
                                                                    <div class="col-lg-6">
																		<div class="form-group">
																			<label class="text-black font-w600">Pays <span class="required">*</span></label>
																			<input type="text" value="{{Auth::user()->country}}" class="form-control" value="Author" name="Author" placeholder="Author">
																		</div>
																	</div>
																	<div class="col-lg-6">
																		<div class="form-group">
																			<label class="text-black font-w600">Phone <span class="required">*</span></label>
																			<input type="text" class="form-control" value="{{Auth::user()->phone}}" placeholder="Email" name="Email">
																		</div>
																	</div>
                                                                    <div class="col-lg-6">
																		<div class="form-group">
																			<label class="text-black font-w600">Email <span class="required">*</span></label>
																			<input type="text" value="{{Auth::user()->email}}" class="form-control" value="Author" name="Author" placeholder="Author">
																		</div>
																	</div>
        ...
        <div class="col-xl-3 col-xxl-4">
            <div class="widget-stat  " style="background-color:#013880">
                <div class="card-header border-0 pb-0 text-center"    style="text-align:center">
                    <h3 class="card-title text-white ">Mon investissement</h3> <hr>
                ...
                <div class="card-body text-center">
                    ...
                    <div class="mt-2">
                      ...
                      <h2><span class="" style="color: white;">Total part: {{($mes_parts[0]->nbr_share)}} parts</span></h2>  
                    </div>
